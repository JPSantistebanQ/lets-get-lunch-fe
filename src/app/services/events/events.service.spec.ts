...
describe('EventsService', () => {
  ...
  describe('create', () => {
    it('should return an event object with valid event details', () => {
      ...
      http
        .expectOne('https://ed-5230661035229184.educative.run:3000/api/events')
        .flush(eventResponse);
  ...
  describe('getUserEvents', () => {
    it('should return events for a user who is a member of events', () => {
      ...
      http
        .expectOne('https://ed-5230661035229184.educative.run:3000/api/events/user/' + user)
        .flush(eventResponse);
      expect(response).toEqual(eventResponse);
      http.verify();
    });
  ...
  describe('get', () => {
    it('should return an event object with a valid event id', () => {
      ...
      http
        .expectOne('https://ed-5230661035229184.educative.run:3000/api/events/' + eventId)
        .flush(eventResponse);
    ...
    it('should return a 404 for an event id that does not exist', () => {
      ...
      http
        .expectOne('https://ed-5230661035229184.educative.run:3000/api/events/' + '1234')
